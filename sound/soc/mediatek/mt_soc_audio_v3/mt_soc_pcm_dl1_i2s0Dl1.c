...
{
	struct snd_pcm_runtime *runtime = substream->runtime;
/*modified by jiaqing.yang for hifi low jitter mode begin*/
#if !defined(CONFIG_MTK_HIFI) && !defined(CONFIG_MTK_NXP_TFA9890)
/*modified by jiaqing.yang for hifi low jitter mode end*/
	uint32 MclkDiv3;
/*modified by jiaqing.yang for hifi low jitter mode begin*/
#endif
/*modified by jiaqing.yang for hifi low jitter mode end*/
...
#if defined(CONFIG_MTK_NXP_TFA9890)
...
/*add by jiaqing.yang for smartpa and hifi low jitter mode begin*/
...
#endif
/*add by jiaqing.yang for smartpa and hifi low jitter mode end*/
		/* I2S out Setting */
