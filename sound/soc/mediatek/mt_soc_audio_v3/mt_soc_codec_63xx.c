...
#ifdef CONFIG_MTK_SPEAKER
//modified for pixi5-5 speaker pa mode
...
/*add by jiaqing.yang for ext amp aw8738 begin*/
#ifdef CONFIG_EXTAMP_AW8738
		AudDrv_GPIO_EXTAMP_Select(true);
		for(aw8738_setMode = 1; aw8738_setMode < CONFIG_EXTAMP_AW8738_MODE; aw8738_setMode++){
		udelay(2);
		AudDrv_GPIO_EXTAMP_Select(false);
		udelay(2);
		AudDrv_GPIO_EXTAMP_Select(true);
...
#endif
/*add by jiaqing.yang for ext amp aw8738 end*/
#endif /*CONFIG_MTK_LEGACY*/
