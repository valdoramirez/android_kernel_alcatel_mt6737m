...
/*add by jiaqing.yang for smartpa low jitter mode end*/
	...
	if (mPrepareDone == false) {
		...
		SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I11,
			      Soc_Aud_InterConnectionOutput_O04);
/*Add by jiaqing.yang for fmradio smartpa routing begin*/
#ifdef CONFIG_MTK_NXP_TFA9890
		SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I10,
			      Soc_Aud_InterConnectionOutput_O00);
		SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I11,
			      Soc_Aud_InterConnectionOutput_O01);
#endif
/*Add by jiaqing.yang for fmradio smartpa routing end*/
...
/*add by jiaqing.yang for hifi low jitter mode begin*/
			...
			SetI2SDacOut(runtime->rate, true, Soc_Aud_I2S_WLEN_WLEN_16BITS);
#else
...
//			Enable4pin_I2S0_I2S3(true, false, substream->runtime->rate);
/*add by jiaqing.yang for smartpa low jitter mode begin*/
