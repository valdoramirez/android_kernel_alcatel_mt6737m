...
/*Add by jiaqing.yang for fmradio and smartpa routing begin*/
...
#endif
/*Add by jiaqing.yang for fmradio and  smartpa routing end*/
	SetI2SADDAEnable(false);  //add by zhiquan.wen.hz for mtk patch buzz6t-p31 on 20161215 for task3721433
	SetI2SAdcEnable(false);
/*Add by jiaqing.yang for HiFi begin*/
#ifndef CONFIG_MTK_HIFI
/*Add by jiaqing.yang for HiFi end*/
...
/*Add by jiaqing.yang for fmradio and hifi smartpa routing begin*/
#ifdef CONFIG_MTK_HIFI
	SetMemoryPathEnable(Soc_Aud_Digital_Block_I2S_OUT_DAC, false);
...
//		Enable4pin_I2S0_I2S3(false, false, runtime->rate);
		Set2ndI2SOutAttribute(substream->runtime->rate);
		Set2ndI2SOutEnable(false);
	}
#endif
/*Add by jiaqing.yang for fmradio and hifi smartpa routing end*/
...
/*add by jiaqing.yang for smartpa and HiFi begin*/
	/* start I2S DAC out */
#ifdef CONFIG_MTK_HIFI
...
/*add by jiaqing.yang for smartpa low jitter mode begin*/
		I2S3_Config.mI2S_SAMPLERATE = substream->runtime->rate;
		I2S3_Config.mI2S_FMT = Soc_Aud_I2S_FORMAT_I2S;
		I2S3_Config.mI2S_WLEN = Soc_Aud_I2S_WLEN_WLEN_16BITS;
...
#endif
/*add by jiaqing.yang for smartpa and HiFi end*/
	Voice_Status = true;
