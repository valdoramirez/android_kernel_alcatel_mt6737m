...
/* BEGIN-yunqi.song add LMK Task 2877961 2016-10-17*/
static int selected_kill_times=0;
module_param_named(selected_kill_times,selected_kill_times,int,
    S_IRUGO | S_IWUSR);
/* END-yunqi.song add LMK Task 2877961 2016-10-17*/
