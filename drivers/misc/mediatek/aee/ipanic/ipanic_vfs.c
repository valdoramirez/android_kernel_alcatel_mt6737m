...
struct file *expdb_open(void)
{
	...
	/* 1440190 Modified by [peng.tian.hz] at [20160119] for open expdb partition error begin */
	if (!filp_expdb || unlikely(filp_expdb == ERR_PTR(-ENOENT)))
	/* 1440190 Modified by [peng.tian.hz] at [20160119] for open expdb partition error end */
