...
//modified by zhuqiang for PR2581287
static u32 charging_hw_init(void *data)
{
	...
	bq24157_reg_config_interface(0x02, 0xB6);
	bq24157_reg_config_interface(0x00, 0xD0);	/* kick chip watch dog */
	bq24157_reg_config_interface(0x01, 0xC8);	/* TE=1, CE=0, HZ_MODE=0, OPA_MODE=0 */
    //[668926] Soul 4.5 550mA charger charging issue by [bin.song.hz] at [2014-5-7] begin
    bq24157_reg_config_interface(0x05,0x06);  //Vsp = 4.52V
    //[668926] Soul 4.5 550mA charger charging issue by [bin.song.hz] at [2014-5-7] end
    /*[998880][MTK Patch]Porting ALPS02058361(For_JRDHZ92_CW_HZ_KK_ALPS.KK1.MP1.V2.10_P68) by liming.zhu at 20150512 begin*/
#ifdef CONFIG_SHINE_LITE
        bq24157_reg_config_interface(0x04,0x71); //146mA
#else
	bq24157_reg_config_interface(0x04,0x73); //146mA
#endif
	/*[998880][MTK Patch]Porting ALPS02058361(For_JRDHZ92_CW_HZ_KK_ALPS.KK1.MP1.V2.10_P68) by liming.zhu at 20150512 end*/
	/*
