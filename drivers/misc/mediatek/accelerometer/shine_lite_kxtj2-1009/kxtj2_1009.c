...
//modify by lanying.he for gsensor beginning
//struct acc_hw accel_cust;
struct acc_hw accel_cust_kxtj2;
//modify by lanying.he for gsensor end
static struct acc_hw *hw = &accel_cust_kxtj2; //modify by lanying.he 

/* For  driver get cust info */
struct acc_hw *get_cust_acc_kxtj2(void)
{
	return &accel_cust_kxtj2;  //modify by lanying.he
}
       ...
       unsigned long arg)
{
	...
	case COMPAT_GSENSOR_IOCTL_READ_SENSORDATA:
		...
		err = file->f_op->unlocked_ioctl(file, GSENSOR_IOCTL_READ_SENSORDATA, (unsigned long)arg32); //modify by lanying.he
		if (err){
...
static long kxtj2_1009_unlocked_ioctl(struct file *file, unsigned int cmd,unsigned long arg)
{
	...
	char strbuf[KXTJ2_1009_BUFSIZE];
	void __user *data;
	struct SENSOR_DATA sensor_data; //modify by lanying.he
	long err = 0;
	int cali[3];
