...
struct acc_hw accel_cust_mc3xxx;
...
static const struct of_device_id accel_of_match[] = {
	//{.compatible = "mediatek,gsensor"}, //modify by lanying.he for gsensor 
...
static int mc3xxx_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	/* begin: Modified by binpeng.huang.hz on 2017.10.10 for XR5393567 */
	if (MC3XXX_RETCODE_SUCCESS != _mc3xxx_i2c_auto_probe(client))
	{
		err = -ENODEV;
		goto exit;
	}
	/* end: Modified by binpeng.huang.hz on 2017.10.10 for XR5393567 */
...
static int __init mc3xxx_init(void)
{
	...
	const char *name = "mediatek,mc3413_p";

	hw = get_accel_dts_func(name, hw);
	if (!hw)
		GSE_ERR("get dts info fail\n");
GSE_ERR("[%s] default direction: %d\n", __FUNCTION__, hw->direction);
