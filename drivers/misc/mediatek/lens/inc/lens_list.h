...
#endif
#ifdef CONFIG_MTK_LENS_DW9719AF_SUPPORT
extern void DW9719AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9719AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9719AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
/*add by zhanyong.yin end*/

/*add by yuda.chen begin*/
#ifdef CONFIG_MTK_LENS_DW9719SAF_SUPPORT
extern void DW9719SAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9719SAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9719SAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
/*add by yuda.chen end*/
