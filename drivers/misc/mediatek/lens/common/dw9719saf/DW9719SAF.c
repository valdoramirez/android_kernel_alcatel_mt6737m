/*
 * DW9719AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9719AF_DRV"
...
static void initdrv(void)
{
	...
	/*modify by yuda.chen begin*/
	char puSendCmd3[2] = { 0x05, 0x03 };//yzy
	/*modify by yuda.chen end*/
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4DW9719AF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long DW9719SAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9719SAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void DW9719SAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
