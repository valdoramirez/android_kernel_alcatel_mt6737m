...
static void initdrv(void)
{
	...
	/*modify by zhanyong.yin at 20160415 begin*/
	char puSendCmd3[2] = { 0x05, 0x03 };//yzy
	/*modify by zhanyong.yin at 20160415 end*/
...
void DW9718SAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
