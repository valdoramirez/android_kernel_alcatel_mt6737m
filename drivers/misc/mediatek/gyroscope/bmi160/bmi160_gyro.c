...
#else
		gyro[BMG_AXIS_X] = (gyro[BMG_AXIS_X] * DEGREE_TO_RAD_SCALE * 5) / 83;
		gyro[BMG_AXIS_Y] = (gyro[BMG_AXIS_Y] * DEGREE_TO_RAD_SCALE * 5) / 83;
		gyro[BMG_AXIS_Z] = (gyro[BMG_AXIS_Z] * DEGREE_TO_RAD_SCALE * 5) / 83;
#endif
