...
#if defined(SHINE4G_S6E8AA5_HD_DSI_VDO)
	&shine4g_s6e8aa5_hd_dsi_vdo_lcm_drv,
#endif

#if defined(SHINELITE_ILI9881C_HD_DSI_TDT)
	&shinelite_ili9881c_hd_dsi_tdt_lcm_drv,
#endif

#if defined(SHINELITE_HX8394F_HD_DSI_EACH)
	&shinelite_hx8394f_hd_dsi_each_lcm_drv,
#endif
...
unsigned char lcm_name_list[][128] = {
		...
		"pixi5_jd9161ba_fwvga_dsi_boe",
#endif
	
#if defined(PIXI5_ST7701_FWVGA_DSI_EACH)
		"pixi5_st7701_fwvga_dsi_each",
#endif
#if defined(PIXI5_ILI9806E_FWVGA_DSI_WTDT)
	"pixi5_ili9806e_fwvga_dsi_wtdt",
#endif
//Begin add by xiaobin.zhai for 4th LCD
#if defined(PIXI5_JD9161BA_FWVGA_DSI_COE)
	"pixi5_jd9161ba_fwvga_dsi_coe",
#endif
//End add by xiaobin.zjhai for 4th LCD
#if defined(HX8392A_DSI_CMD)
	"hx8392a_dsi_cmd",
#endif
...
unsigned int lcm_num = sizeof(lcm_name_list) / (sizeof(unsigned char)*128);
#endif
