...
//Added by jiabin.zheng.hz for Defect4554331 on 2017/05/04 begin
#if CFG_SUPPORT_RN
...
#endif
//Added by jiabin.zheng.hz for Defect4554331 on 2017/05/04 end
				...
				IN P_BSS_INFO_T prAisBssInfo, IN ENUM_AA_FRM_TYPE_T eFrmType)
{
	...
	//Added by jiabin.zheng.hz for Defect4641012 on 2017/04/27 begin
	P_AIS_FSM_INFO_T prAisFsmInfo;
	ENUM_AA_STATE_T eNextState;
	//Added by jiabin.zheng.hz for Defect4641012 on 2017/04/27 end
	...
	*/
	...
	if ((eFrmType == FRM_DEAUTH) && (prAisFsmInfo->eCurrentState == AIS_STATE_JOIN) 
		 ...
		 */
		 prStaRec->u2StatusCode = STATUS_CODE_ASSOC_TIMEOUT;
		 eNextState = AA_STATE_IDLE; saaFsmSteps(prAdapter, prStaRec, eNextState, NULL); 
	} else 
	//Added by jiabin.zheng.hz for Defect4641012 on 2017/04/27 end
...
//Modified by jiabin.zheng.hz for Defect4554331 on 2017/05/04 begin
				// if (STA_STATE_2 <= prStaRec->ucStaState) {
				// 	P_MSG_AIS_ABORT_T prAisAbortMsg;
...
#endif
//Modified by jiabin.zheng.hz for Defect4554331 on 2017/05/04 end
			}
