...
#if 0//def CONFIG_OF
static unsigned int pin_ext_dac_rst, pin_ext_hp_en, pin_nxpspk_lrck, pin_nxpspk_bck,
	pin_nxpspk_datai, pin_nxpspk_datao;
static unsigned int pin_ext_dac_rst_mode, pin_ext_hp_en_mode, pin_nxpspk_lrck_mode,
	pin_nxpspk_bck_mode, pin_nxpspk_datai_mode, pin_nxpspk_datao_mode;
...
#ifdef CONFIG_MTK_NXP_TFA9890
	mt_set_gpio_mode(GPIO_SMARTPA_RST_PIN /*GPIO130 */ , GPIO_MODE_00);
	mt_set_gpio_out(GPIO_SMARTPA_RST_PIN /*GPIO130 */ , GPIO_OUT_ZERO);
	usleep_range(2*1000, 3*1000);
	mt_set_gpio_out(GPIO_SMARTPA_RST_PIN /*GPIO130 */ , GPIO_OUT_ONE);
	usleep_range(2*1000, 3*1000);
	mt_set_gpio_out(GPIO_SMARTPA_RST_PIN /*GPIO130 */ , GPIO_OUT_ZERO);
