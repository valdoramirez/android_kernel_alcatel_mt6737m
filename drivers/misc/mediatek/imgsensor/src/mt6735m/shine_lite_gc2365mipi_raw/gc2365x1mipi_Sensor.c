...
#include "gc2365x1mipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2365x1_camera_sensor"
#define LOG_1 LOG_INF("GC2365X1,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/

//#define LOG_INF(format, args...)    pr_debug(ANDROID_LOG_INFO   , PFX, "[%s] " format, __FUNCTION__, ##args)
#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)
static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool GC2365X1DuringTestPattern = KAL_FALSE;
...
static kal_uint32 open(void)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    GC2365X1DuringTestPattern = KAL_FALSE; 
...
UINT32 GC2365X1MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
