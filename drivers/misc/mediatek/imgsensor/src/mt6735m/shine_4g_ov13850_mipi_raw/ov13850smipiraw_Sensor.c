...
#define PFX "OV13850s_camera_sensor"
#define LOG_1 LOG_INF("OV13850s,MIPI 4LANE\n")
   ...
   //write_cmos_sensor(0x0103, 0x01);//,
	  write_cmos_sensor(0x351b, 0x00);
		...
		*/
		...
		write_cmos_sensor(0x3605, 0x95);//0xb5
...
if (capture_first_flag == 0)
{
    ...
    } else {   //28fps            //30fps for Normal capture & ZSD
 
      		write_cmos_sensor(0x0300, 0x00);//
			write_cmos_sensor(0x0302, 0x2B);//
			write_cmos_sensor(0x0303, 0x00);//
        ...
        do {
            *sensor_id = return_sensor_id();
			...
			checkOTP();
					...
					sprintf(Back_Camera_Name,"OV13850:Q_tech:SUP1:13M_AF"); 
					if(OV13850_OTP_FLAG==1){
...
UINT32 OV13850S_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
