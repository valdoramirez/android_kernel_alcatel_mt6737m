...
#define SUPPORT_I2C_BUS_NUM2        0//yzy
...
//Begin added for pixi5-5 D3065943 on 20161015
...
//End added for pixi5-5 D3065943 on 20161015
/*******************************************************************************
*iMultiReadReg
********************************************************************************/
...
{
//Begin modified for pixi5-5 D3065943 on 20161015
...
//End modified for pixi5-5 D3065943 on 20161015  
	for (i = KDIMGSENSOR_INVOKE_DRIVER_0; i < KDIMGSENSOR_MAX_INVOKE_DRIVERS; i++) {
		/*  */
		spin_lock(&kdsensor_drv_lock);
	...
	if (1) {
		...
		if (node) {
			...
			if (name == NULL) {
				...
				/*task 1722575 modify by zhanyong.yin at 20160303 begin*/
				if (regSubVCAMD == NULL) {
					regSubVCAMD = regulator_get(sensor_device, "vgp1");//yzy
				}
				/*task 1722575 modify by zhanyong.yin at 20160303 end*/
			} else {
				...
				if (regSubVCAMD == NULL) {
					regSubVCAMD =
					/*task 1722575 modify by zhanyong.yin at 20160303 begin*/
					    regulator_get(sensor_device, "vgp1");//yzy
					/*task 1722575 modify by zhanyong.yin at 20160303 end*/
				}
				if (regVCAMIO == NULL) {
					regVCAMIO =
