...
{
//Begin added for pixi5-5 camera

//5MAF_MAIN
#if defined(PIXI55_OV5675_AF_MIPI_RAW)
    {OV5675AF_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5675_AF_MIPI_RAW, OV5675_AF_MIPI_RAW_SensorInit},
#endif

//5MFF_MAIN
#if defined(PIXI55_OV5675_MIPI_RAW)
    {OV5675MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5675_MIPI_RAW, OV5675_MIPI_RAW_SensorInit},
//{OV5675MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5675_MIPI_RAW, HI553_MIPI_RAW_SensorInit},
#endif
//5MFF_MAIN
#if defined(PIXI55_HI553_MIPI_RAW)
    {HI553_SENSOR_ID, SENSOR_DRVNAME_HI553_MIPI_RAW, HI553_MIPI_RAW_SensorInit},
#endif


//8MAF
#if defined(PIXI55_OV8856_MIPI_RAW)
    {OV8856_SENSOR_ID, SENSOR_DRVNAME_OV8856_MIPI_RAW, OV8856_MIPI_RAW_SensorInit},
#endif
//2M_FRONT
#if defined(PIXI55_SP2509_MIPI_RAW)
    {SP2509_SENSOR_ID, SENSOR_DRVNAME_SP2509_MIPI_RAW, SP2509_MIPI_RAW_SensorInit},
#endif
//2M_FRONT
//Begin added for pixi5-5 camera 2nd source sub-camera by yun-ling@tcl.com
#if defined(PIXI55_GC2375MIPI_RAW)
    {GC2375MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2375_MIPI_RAW, GC2375MIPI_RAW_SensorInit},
//end added for pixi5-5 camera 2nd source sub-camera by yun-ling@tcl.com
#endif
//End added for pixi5-5 camera
/*task 1722575 modify by zhanyong.yin at 20160303 begin*/
#if defined(SHINE_4G_OV8856_MIPI_RAW)
    {OV8856_SENSOR_ID, SENSOR_DRVNAME_OV8856_MIPI_RAW, OV8856_MIPI_RAW_SensorInit},
#endif

#if defined(SHINE_4G_GC2365MIPI_RAW)
    {GC2365MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2365MIPI_RAW, GC2365MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_LITE_OV13853_MIPI_RAW)
    {OV13853_SENSOR_ID, SENSOR_DRVNAME_OV13853_MIPI_RAW,OV13853_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_LITE_OV13850_MIPI_RAW)
    {OV13850_SENSOR_ID, SENSOR_DRVNAME_OV13850_MIPI_RAW,OV13850_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_4G_OV13850_MIPI_RAW)
    {OV13850S_SENSOR_ID, SENSOR_DRVNAME_OV13850S_MIPI_RAW,OV13850S_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_LITE_S5K3M2_MIPI_RAW)
    {S5K3M2_SENSOR_ID, SENSOR_DRVNAME_S5K3M2_MIPI_RAW,S5K3M2_MIPI_RAW_SensorInit},
#endif
/*add by yuda.chen begin*/
#if defined(SHINE_4G_S5K3M2_MIPI_RAW)
    {S5K3M2S_SENSOR_ID, SENSOR_DRVNAME_S5K3M2S_MIPI_RAW,S5K3M2S_MIPI_RAW_SensorInit},
#endif
/*add by yuda.chen end*/
#if defined(SHINE_4G_S5K5E8YX_MIPI_RAW)
    {S5K5E8YX_SENSOR_ID, SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW, S5K5E8YX_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_LITE_S5K5E8YX_MIPI_RAW)
    {S5K5E8YXX1_SENSOR_ID, SENSOR_DRVNAME_S5K5E8YXX1_MIPI_RAW, S5K5E8YXX1_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_LITE_OV8856_MIPI_RAW)
    {OV8856X1_SENSOR_ID, SENSOR_DRVNAME_OV8856X1_MIPI_RAW, OV8856X1_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_4G_OV5675_MIPI_RAW)
    {OV5675MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5675_MIPI_RAW, OV5675_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_LITE_OV5675_MIPI_RAW)
    {OV5675X1MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5675X1_MIPI_RAW, OV5675X1_MIPI_RAW_SensorInit},
#endif
#if defined(SHINE_LITE_GC2365MIPI_RAW)
    {GC2365X1MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2365X1MIPI_RAW, GC2365X1MIPI_RAW_SensorInit},
#endif
/*task 1722575 modify by zhanyong.yin at 20160303 end*/
/*IMX*/
