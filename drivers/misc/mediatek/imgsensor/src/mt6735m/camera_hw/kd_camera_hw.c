...
struct pinctrl_state *cam0_af_h =NULL;
struct pinctrl_state *cam0_af_l =NULL;
...
#define VOL_1000 1000000
	...
	if (On) {
	    ...
	    if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV8856_MIPI_RAW, currSensorName)) && (pinSetIdx == 0))
        {
	            PK_DBG("kdCISModulePower--On get in---SENSOR_DRVNAME_OV8856_MIPI_RAW \n");
		    ...
		    //mdelay(1);
				...
				mtkcam_gpio_set(pinSetIdx, CAMLDO, GPIO_OUT_ONE);

	            mdelay(5);
        }
			
        else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5675_MIPI_RAW, currSensorName)) && (pinSetIdx == 0))
        {
            PK_DBG("kdCISModulePower--On get in---SENSOR_DRVNAME_OV5675_MIPI_RAW \n");
        ...
        else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5675_AF_MIPI_RAW, currSensorName)) && (pinSetIdx == 0))
        {
            PK_DBG("kdCISModulePower--On get in---SENSOR_DRVNAME_OV5675_AF_MIPI_RAW \n");
		...
		//disable inactive sensor
	        ...
	        mdelay(5);
			//AF :pull  DW9814 XSD pin to high for i2c connect
			mtkcam_gpio_set(pinSetIdx, CAMLDO, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
        ...
        else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI553_MIPI_RAW, currSensorName)) && (pinSetIdx == 0))
        {
            PK_DBG("kdCISModulePower--On get in---SENSOR_DRVNAME_HI553_MIPI_RAW \n");
        ...
        else  if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW, currSensorName)) && (pinSetIdx == 1))
        {

		PK_DBG("kdCISModulePower--On get in---SENSOR_DRVNAME_SP2509_MIPI_RAW \n");
		//disable inactive sensor
        ...
        else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2375_MIPI_RAW, currSensorName)) && (pinSetIdx == 1))
        {
				PK_DBG("kdCISModulePower--On get in---SENSOR_DRVNAME_GC2375_MIPI_RAW \n");
				mtkcam_gpio_set(pinSetIdx, CAMRST, pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_OFF]);
		 		mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
				mdelay(3);
				 //IOVDD raise
		...
		if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV8856_MIPI_RAW, currSensorName)) && (pinSetIdx == 0))
        {
		        PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_OV8856_MIPI_RAW\n");
				...
				mtkcam_gpio_set(pinSetIdx, CAMLDO, GPIO_OUT_ZERO);		
                mdelay(5);
    ...
    else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5675_MIPI_RAW, currSensorName)) && (pinSetIdx == 0))
    {
		...
		PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_OV5675_MIPI_RAW\n");
	...
	else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5675_AF_MIPI_RAW, currSensorName)) && (pinSetIdx == 0))
		{
			...
			PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_OV5675_AF_MIPI_RAW\n");
			...
			mdelay(1);
			   ...
			   goto _kdCISModulePowerOn_exit_;
				...
				//AF :pull down  DW9814 XSD pin for i2c disconnect
			mtkcam_gpio_set(pinSetIdx, CAMLDO, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
				/*if(TRUE != _hwPowerDownCnt(VCAMAF,mode_name))
				 {
     ...
     {
         PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_HI553_MIPI_RAW\n");
         if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
              mtkcam_gpio_set(pinSetIdx, CAMRST, pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_OFF]);  
         }
         if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
    ...
    {
        PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_SP2509_MIPI_RAW\n");
        if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
            mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
        }		
		mdelay(2);
        ...
        {
			PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_GC2375_MIPI_RAW\n");
