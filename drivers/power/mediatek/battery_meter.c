 ...
 void fgauge_get_battery_vender_type(void)
{
  ...
  bat_id_vol = bat_id_vol/3;
   ...
   if((bat_id_vol>=324)&&(bat_id_vol<=524))
	...
	/* begin: add by binpeng.huang on 2016.03.31 for Defect 1862690 */
   else if (bat_id_vol >= 1243 && bat_id_vol <= 1443)
   {
	   battery_vender_type = 1;
   	   printk("[fgauge_get_battery_vender_type] scud battery use byd parameters\n");
   }
	/* end: add by binpeng.huang on 2016.03.31 for Defect 1862690 */
   else
   	{
...
/*end modify by qiuguang.liang on 20160614 for defect 2167400*/
    ...
    {
/*begin add by qiuguang.liang on 20160614 for defect 2167400*/
	printk("%s is ready \n",path);
/*end add  by qiuguang.liang on 20160614 for defect 2167400*/
...
/*modify by qiuguang.liang on 20160614 for defect 2167400*/
