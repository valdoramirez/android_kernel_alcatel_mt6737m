...
/* [defect 950605] add by bin.song.hz at 2015.5.19 for reset PMIC circuit when reboot into recovery bingen */
#include <mt-plat/upmu_common.h>
/* [defect 950605] add by bin.song.hz at 2015.5.19 for reset PMIC circuit when reboot into recovery end */
...
void arch_reset(char mode, const char *cmd)
{
	...
	if (cmd && !strcmp(cmd, "charger")) {
		...
		rtc_mark_recovery();
		/* [defect 950605] add by bin.song.hz at 2015.5.19 for reset PMIC circuit when reboot into recovery begin */
		...
		rtc_mark_fast();
	  /* [defect 950605] add by bin.song.hz at 2015.5.19 for reset PMIC circuit when reboot into fastboot begin */
        pmic_set_register_value(PMIC_RG_WDTRSTB_MODE, 1);
        pmic_set_register_value(PMIC_WDTRSTB_STATUS, 1);
        pmic_set_register_value(PMIC_RG_WDTRSTB_FB_EN, 1);
        /* [defect 950605] add by bin.song.hz at 2015.5.19 for reset PMIC circuit when reboot into fastboot end */ 
