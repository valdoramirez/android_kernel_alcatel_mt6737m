...
{
//-Begin-yaosen.lin modify for long press power key not to shutdown Task2808725-20160918
#ifdef TARGET_BUILD_MMITEST
	kpd_info("mmitest need press two key to reboot\n");
	...
	return;
#endif
//-End-yaosen.lin modify for long press power key not to shutdown Task2808725-20160918
#ifndef EVB_PLATFORM
...
//#ifndef CONFIG_FCC_PTCRB_SUPPORT//# [1936314] modified by zhuqiang for fcc ptcrb test
