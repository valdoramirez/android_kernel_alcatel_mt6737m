...
#ifndef __SL_SPIDEV_H__
#define __SL_SPIDEV_H__
 ...
 */
//modified by peng.tian.hz begin
#define FP_CONPAT 1
//modified by peng.tian.hz end
...
#define IOCTL_FINGER_STATUS  _IOW(SPI_IOC_MAGIC, 82, __u32)
