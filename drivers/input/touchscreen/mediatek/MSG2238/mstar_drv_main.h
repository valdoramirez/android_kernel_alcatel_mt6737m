...
#define PROC_NODE_PROXIMITY_ASSISTANCE           "prox_assist"
...
#ifdef CONFIG_ENABLE_PROXIMITY_ASSISTANCE_BY_GSENSOR
extern ssize_t DrvMainProcfsProxAssistanceRead(struct file * pFile, char __user * pBuffer, size_t nCount, loff_t * pPos);
extern ssize_t DrvMainProcfsProxAssistanceWrite(struct file * pFile, const char __user * pBuffer, size_t nCount, loff_t * pPos);
#endif //CONFIG_ENABLE_PROXIMITY_ASSISTANCE_BY_GSENSOR
