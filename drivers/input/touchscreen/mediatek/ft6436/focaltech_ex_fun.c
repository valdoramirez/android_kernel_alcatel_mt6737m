...
#include <tpd.h>//add by xiaobin.zhai for hardwareinfo
...
extern struct tpd_device *tpd; //20161208 add by xiaobin.zhai for hardwareinfo
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	tpd->tp_firmware_version=uc_tp_fm_ver;//20160226 xiaobin.zhai add for hardwareinfo
